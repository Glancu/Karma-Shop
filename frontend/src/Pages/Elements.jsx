...
import imgElementD from '../../public/assets/img/elements/d.jpg';

import imgElementF1 from '../../public/assets/img/elements/f1.jpg';
import imgElementF2 from '../../public/assets/img/elements/f2.jpg';
import imgElementF3 from '../../public/assets/img/elements/f3.jpg';
import imgElementF4 from '../../public/assets/img/elements/f4.jpg';
import imgElementF5 from '../../public/assets/img/elements/f5.jpg';
import imgElementF6 from '../../public/assets/img/elements/f6.jpg';
import imgElementF7 from '../../public/assets/img/elements/f7.jpg';
import imgElementF8 from '../../public/assets/img/elements/f8.jpg';

import imgElementG1 from '../../public/assets/img/elements/g1.jpg';
import imgElementG2 from '../../public/assets/img/elements/g2.jpg';
import imgElementG3 from '../../public/assets/img/elements/g3.jpg';
import imgElementG4 from '../../public/assets/img/elements/g4.jpg';
import imgElementG5 from '../../public/assets/img/elements/g5.jpg';
import imgElementG6 from '../../public/assets/img/elements/g6.jpg';
import imgElementG7 from '../../public/assets/img/elements/g7.jpg';
import imgElementG8 from '../../public/assets/img/elements/g8.jpg';
                    ...
                    <div className="container border-top-generic">
                        ...
                        <div className="button-group-area mt-40">
                            <a href="#" className="genric-btn default circle arrow">
                                Default<span className="lnr lnr-arrow-right"/>
                            </a>
                            <a href="#" className="genric-btn primary circle arrow">
                                Primary<span className="lnr lnr-arrow-right"/>
                            </a>
                            <a href="#" className="genric-btn success circle arrow">
                                Success<span className="lnr lnr-arrow-right"/>
                            </a>
                            <a href="#" className="genric-btn info circle arrow">
                                Info<span className="lnr lnr-arrow-right"/>
                            </a>
                            <a href="#" className="genric-btn warning circle arrow">
                                Warning<span className="lnr lnr-arrow-right"/>
                            </a>
                            <a href="#" className="genric-btn danger circle arrow">
                                Danger<span className="lnr lnr-arrow-right"/>
                            </a>
                        </div>
                        <div className="button-group-area mt-10">
                    ...
                    <div className="container">
                            ...
                            <div className="row">
                                <div className="col-md-9">
                                    <p className="text-right">Over time, even the most sophisticated, memory packed
                                        ...
                                        your PC running at its best. You
                                    ...
                                    <p className="text-right">Before we discuss all of the things that could be
                                        affecting your PC’s performance, let’s
                            ...
                            <div className="progress-table-wrap">
                                <div className="progress-table">
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country"><img src={imgElementF1} alt="flag"/>Canada</div>
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country"><img src={imgElementF2} alt="flag"/>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country"><img src={imgElementF3} alt="flag"/>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country"><img src={imgElementF4} alt="flag"/>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country"><img src={imgElementF5} alt="flag"/>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country"><img src={imgElementF6} alt="flag"/>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country"><img src={imgElementF7} alt="flag"/>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                                    ...
                                    <div className="table-row">
                                        ...
                                        <div className="country"><img src={imgElementF8} alt="flag"/>Canada</div>
                                        <div className="visit">645032</div>
                                        <div className="percentage">
                                            <div className="progress">
                        ...
                        <div className="section-top-border">
                            ...
                            <div className="row gallery-item">
                                <div className="col-md-4">
                                    <a href={imgElementG1} className="img-pop-up">
                                ...
                                <div className="col-md-4">
                                    <a href={imgElementG2} className="img-pop-up">
                                        <div className="single-gallery-image"
                                ...
                                <div className="col-md-4">
                                    <a href={imgElementG3} className="img-pop-up">
                                        <div className="single-gallery-image"
                                ...
                                <div className="col-md-6">
                                    <a href={imgElementG4} className="img-pop-up">
                                        <div className="single-gallery-image"
                                ...
                                <div className="col-md-6">
                                    <a href={imgElementG5} className="img-pop-up">
                                        <div className="single-gallery-image"
                                ...
                                <div className="col-md-4">
                                    <a href={imgElementG6} className="img-pop-up">
                                        <div className="single-gallery-image"
                                ...
                                <div className="col-md-4">
                                    <a href={imgElementG7} className="img-pop-up">
                                        <div className="single-gallery-image"
                                ...
                                <div className="col-md-4">
                                    <a href={imgElementG8} className="img-pop-up">
                                        <div className="single-gallery-image"
                                ...
                                <div className="col-lg-8 col-md-8">
                                    ...
                                    <form action="#">
                                        ...
                                        <div className="input-group-icon mt-10">
                                            <div className="icon"><i className="fa fa-thumb-tack" aria-hidden="true"/>
                                            </div>
                                            <input type="text"
                                                   name="address"
                                                   placeholder="Address"
                                ...
                                <div className="col-lg-3 col-md-4 mt-sm-30">
                                    <div className="single-element-widget">
                                        ...
                                        <div className="switch-wrap d-flex justify-content-between">
                                            ...
                                            <div className="primary-switch">
                                                <input type="checkbox" id="primary-switch" defaultChecked={true}/>
                                        ...
                                        <div className="switch-wrap d-flex justify-content-between">
                                            ...
                                            <div className="confirm-switch">
                                                <input type="checkbox" id="confirm-switch" defaultChecked={true}/>
                                    ...
                                    <div className="single-element-widget mt-30">
                                        ...
                                        <div className="switch-wrap d-flex justify-content-between">
                                            ...
                                            <div className="primary-checkbox">
                                                <input type="checkbox" id="primary-checkbox" defaultChecked={true}/>
                                        ...
                                        <div className="switch-wrap d-flex justify-content-between">
                                            ...
                                            <div className="disabled-checkbox">
                                                <input type="checkbox" id="disabled-checkbox-active" defaultChecked={true} disabled/>
                                    ...
                                    <div className="single-element-widget mt-30">
                                        ...
                                        <div className="switch-wrap d-flex justify-content-between">
                                            ...
                                            <div className="primary-radio">
                                                <input type="checkbox" id="primary-radio" defaultChecked={true}/>
                                        ...
                                        <div className="switch-wrap d-flex justify-content-between">
                                            ...
                                            <div className="confirm-radio">
                                                <input type="checkbox" id="confirm-radio" defaultChecked={true}/>
                                        ...
                                        <div className="switch-wrap d-flex justify-content-between">
                                            ...
                                            <div className="disabled-radio">
                                                <input type="checkbox" id="disabled-radio-active" defaultChecked={true} disabled/>
