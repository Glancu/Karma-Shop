...
import imgFeature1 from '../../../public/assets/img/blog/feature-img1.jpg';

import imgPostImg1 from '../../../public/assets/img/blog/post-img1.jpg';
import imgPostImg2 from '../../../public/assets/img/blog/post-img2.jpg';

import imgPrev from '../../../public/assets/img/blog/prev.jpg';
import imgNext from '../../../public/assets/img/blog/next.jpg';

import imgPostThumb1 from '../../../public/assets/img/blog/c1.jpg';
import imgPostThumb2 from '../../../public/assets/img/blog/c2.jpg';
import imgPostThumb3 from '../../../public/assets/img/blog/c3.jpg';
import imgPostThumb4 from '../../../public/assets/img/blog/c4.jpg';
import imgPostThumb5 from '../../../public/assets/img/blog/c5.jpg';

import imgAuthorPost from '../../../public/assets/img/blog/author.png';

import imgPopularPost1 from'../../../public/assets/img/blog/popular-post/post1.jpg';
import imgPopularPost2 from'../../../public/assets/img/blog/popular-post/post2.jpg';
import imgPopularPost3 from'../../../public/assets/img/blog/popular-post/post3.jpg';
import imgPopularPost4 from'../../../public/assets/img/blog/popular-post/post4.jpg';

import imgAdd from '../../../public/assets/img/blog/add.jpg';
                                ...
                                <div className="single-post row">
                                    <div className="col-lg-12">
                                        <div className="feature-img">
                                            <img className="img-fluid" src={imgFeature1} alt=""/>
                                        </div>
                                    </div>
                                    <div className="col-lg-3  col-md-3">
                                        <div className="blog_info text-right">
                                            ...
                                            <ul className="blog_meta list">
                                                ...
                                                <li>
                                                    <a href="#">12 Dec, 2018<i className="lnr lnr-calendar-full"/></a>
                                                </li>
                                    ...
                                    <div className="col-lg-9 col-md-9 blog_details">
                                        ...
                                        <p>
                                            ...
                                            actually
                                            sit through a self-imposed MCSE training. who has the willpower to actually
                                            sit through
                                            a self-imposed
                                        </p>
                                        <p>
                                    ...
                                    <div className="col-lg-12">
                                        ...
                                        <div className="row">
                                            <div className="col-6">
                                                <img className="img-fluid" src={imgPostImg1} alt=""/>
                                            </div>
                                            <div className="col-6">
                                                <img className="img-fluid" src={imgPostImg2} alt=""/>
                                            </div>
                                ...
                                <div className="navigation-area">
                                    <div className="row">
                                        <div
                                            ...
                                            <div className="thumb">
                                                <a href="#">
                                                    <img className="img-fluid" src={imgPrev} alt=""/>
                                                </a>
                                            </div>
                                            <div className="arrow">
                                        ...
                                        <div
                                            ...
                                            <div className="thumb">
                                                <a href="#">
                                                    <img className="img-fluid" src={imgNext} alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-lg-4">
                                <div className="blog_right_sidebar">
                                    ...
                                    <aside className="single_sidebar_widget author_widget">
                                        <img className="author_img rounded-circle" src={imgAuthorPost} alt=""/>
                                        ...
                                        <p>Boot camps have its supporters andit sdetractors. Some people do not
                                            understand why you
                                            should have to spend money on boot camp when you can get. Boot camps
                                            have itssuppor
                                    ...
                                    <aside className="single_sidebar_widget popular_post_widget">
                                        ...
                                        <div className="media post_item">
                                            <img src={imgPopularPost1} alt="post"/>
                                        ...
                                        <div className="media post_item">
                                            <img src={imgPopularPost2} alt="post"/>
                                            <div className="media-body">
                                                <a href="blog-details.html">
                                        ...
                                        <div className="media post_item">
                                            <img src={imgPopularPost3} alt="post"/>
                                            <div className="media-body">
                                                <a href="blog-details.html">
                                        ...
                                        <div className="media post_item">
                                            <img src={imgPopularPost4} alt="post"/>
                                            <div className="media-body">
                                                <a href="blog-details.html">
                                    ...
                                    <aside className="single_sidebar_widget ads_widget">
                                        <a href="#"><img className="img-fluid" src={imgAdd} alt=""/></a>
                                        <div className="br"/>
                                    </aside>
